...
const PRODUCTS = {
  beer: [
    ...
    {name:'Coors Light',        sub:'Light Beer',           domain:'coorslight.com',      color:'#0095b6', sizes:['6-Pack','12-Pack','24-Pack','30-Pack'], localImg:'https://coorslight.com/sites/coorslight/files/inline-images/COORS_LIGHT_12OZ_SKINNY_WARP_TV_AND_MEDIA_EXPORT_3_2.png'},
    {name:'Corona Extra',       sub:'Mexican Lager',        domain:'corona.com',          color:'#c8900a', sizes:['6-Pack','12-Pack','24-Pack'],           localImg:'https://www.coronausa.com/cdn/shop/files/corona-extra-menu_300x.png?v=1614355250'},
    {name:'Modelo Especial',    sub:'Pilsner',              domain:'modelo.com',          color:'#003a7a', sizes:['6-Pack','12-Pack','24-Pack'],           localImg:'https://www.modelousa.com/cdn/shop/files/img-wrap.png?v=1756633545&width=400'},
    {name:'Modelo Negra',       sub:'Munich Dunkel',        domain:'modelo.com',          color:'#1a0800', sizes:['6-Pack','12-Pack','24-Pack'],           localImg:'https://www.modelousa.com/cdn/shop/files/beer.png?v=1757020891&width=400'},
    {name:'Heineken',           sub:'Dutch Lager',          domain:'heineken.com',        color:'#005e23', sizes:['6-Pack','12-Pack','24-Pack']},
    {name:'Miller Lite',        sub:'American Light Lager', domain:'millerlite.com',      color:'#00539f', sizes:['6-Pack','12-Pack','30-Pack'],           localImg:'https://www.millerlite.com/sites/millerlite/files/inline-images/ML%20can_0%20%281%29_0.png'},
    {name:'Blue Moon',          sub:'Belgian White',        domain:'bluemoonbrewing.com', color:'#00437a', sizes:['6-Pack','12-Pack']},
    {name:'Stella Artois',      sub:'Belgian Lager',        domain:'stellaartois.com',    color:'#003b6f', sizes:['6-Pack','12-Pack']},
  ...
  whiskey: [
    {name:"Jack Daniel's Old No.7", sub:'Tennessee Whiskey',          domain:'jackdaniels.com',        color:'#111111', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Jameson Irish Whiskey',  sub:'Irish Whiskey · Triple Dist', domain:'jamesonwhiskey.com',    color:'#005e23', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Crown Royal',            sub:'Canadian Whisky',             domain:'crownroyal.com',         color:'#5a1a8a', sizes:['375ml Pint','750ml','1.75L'],          localImg:'https://images.ctfassets.net/wf4e4r4dkfx8/5odLcNIuihSnK1grd5vEVp/a109d22042dbbe778f0ae72486353f22/Crown_Royal_Artful_Deluxe_with_Box_Close_Up__1_-1.jpg?fm=avif&w=800&q=80'},
    {name:"Maker's Mark",           sub:'Kentucky Straight Bourbon',   domain:'makersmark.com',         color:'#a41020', sizes:['375ml Pint','750ml','1L','1.75L'],    localImg:'https://www.makersmark.com/sites/default/files/styles/original/public/2025-06/makers-mark-bottle-bourbon-whiskey-classic.png.webp?itok=eoRW3x0g'},
    {name:'Bulleit Bourbon',        sub:'Kentucky Straight Bourbon',   domain:'bulleit.com',            color:'#b03010', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Jim Beam White Label',   sub:'Kentucky Straight Bourbon',   domain:'jimbeam.com',            color:'#1a3a6b', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Wild Turkey 101',        sub:'Kentucky Bourbon',            domain:'wildturkeybourbon.com',  color:'#7a2a00', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Knob Creek Small Batch', sub:'Small Batch Bourbon',         domain:'knobcreek.com',          color:'#4a1808', sizes:['375ml Pint','750ml']},
    {name:'Johnnie Walker Black',   sub:'Blended Scotch Whisky',       domain:'johnniewalker.com',      color:'#1a1a2e', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Glenlivet 12 Year',      sub:'Single Malt Scotch',          domain:'theglenlivet.com',       color:'#9a6800', sizes:['750ml','1.75L']},
    {name:"Jack Daniel's Honey",    sub:'Tennessee Honey Liqueur',     domain:'jackdaniels.com',        color:'#b07800', sizes:['750ml','1L']},
    {name:'Evan Williams Black',    sub:'Kentucky Straight Bourbon',   domain:'evanwilliams.com',       color:'#1a2a4a', sizes:['750ml','1.75L']},
  ],
  vodka: [
    {name:"Tito's Handmade Vodka",  sub:'Texas Vodka · Corn-based',   domain:'titosvodka.com',        color:'#003087', sizes:['375ml Pint','750ml','1L','1.75L'], localImg:'https://www.titosvodka.com/static/img/age-gate-bottle.webp'},
    {name:'Grey Goose',             sub:'French Vodka · Wheat',       domain:'greygoose.com',         color:'#1a3a7a', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Absolut Original',       sub:'Swedish Vodka · Winter Wheat',domain:'absolut.com',          color:'#003a9a', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Smirnoff No. 21',        sub:'Triple Distilled',           domain:'smirnoff.com',          color:'#a41020', sizes:['375ml Pint','750ml','1L','1.75L']},
    {name:'Ketel One',              sub:'Dutch Vodka · Wheat',        domain:'ketelone.com',          color:'#1a3a6b', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Belvedere',              sub:'Polish Rye Vodka',           domain:'belvederevodka.com',    color:'#1a1a3a', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Cîroc',                  sub:'French Vodka · Grapes',      domain:'ciroc.com',             color:'#1a5ca8', sizes:['375ml Pint','750ml','1.75L']},
    {name:'New Amsterdam',          sub:'California Vodka',           domain:'newamsterdamvodka.com', color:'#002050', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Skyy Vodka',             sub:'American Vodka',             domain:'skyy.com',              color:'#0040a0', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Stolichnaya',            sub:'Russian Vodka · Wheat & Rye',domain:'stoli.com',             color:'#a41020', sizes:['375ml Pint','750ml','1.75L']},
    {name:'Pinnacle Vodka',         sub:'French Vodka · Wheat',       domain:'pinnaclevodka.com',     color:'#1a4a8a', sizes:['750ml','1.75L']},
    {name:'Three Olives',           sub:'English Vodka · Wheat',      domain:'threeolives.com',       color:'#1a5a2a', sizes:['750ml','1.75L']},
  ],
  tequila: [
  ...
  shots: [
    {name:'Fireball Cinnamon',      sub:'Cinnamon Whisky Liqueur',    domain:'fireballwhisky.com',   color:'#a41020', sizes:['50ml Mini','375ml Pint','750ml','1.75L']},
