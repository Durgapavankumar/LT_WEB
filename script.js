...
/* ── BRAND POSTERS ───────────────────────────────────────── */
const BRANDS = [
  {name:"Jack Daniel's",  domain:'jackdaniels.com',        color:'#1a1a1a', cat:'Whiskey', img:'images/whiskey/jack_daniel_bottle.webp'},
  {name:'Jameson',        domain:'jamesonwhiskey.com',     color:'#005e23', cat:'Whiskey', img:'images/whiskey/jameson_bottle.jpeg'},
  {name:'Crown Royal',    domain:'crownroyal.com',         color:'#5a1a8a', cat:'Whiskey', img:'images/whiskey/crown_royal.webp'},
  {name:"Maker's Mark",   domain:'makersmark.com',         color:'#a41020', cat:'Whiskey', img:'images/whiskey/makers_mark.webp'},
  {name:'Bulleit',        domain:'bulleit.com',            color:'#b03010', cat:'Whiskey', img:'images/whiskey/bulleit_bourbon.webp'},
  {name:'Hennessy',       domain:'hennessy.com',           color:'#1a0a00', cat:'Cognac',  img:'images/whiskey/Hennessy.jpeg'},
  {name:'Fireball',       domain:'fireballwhisky.com',     color:'#c42000', cat:'Whiskey', img:'images/whiskey/fireball.jpg'},
  {name:"Tito's",         domain:'titosvodka.com',         color:'#003087', cat:'Vodka',   img:'images/vodka/Titos.jpeg'},
  {name:'Grey Goose',     domain:'greygoose.com',          color:'#1a3a7a', cat:'Vodka',   img:'images/vodka/grey_goose.webp'},
  {name:'Absolut',        domain:'absolut.com',            color:'#003a9a', cat:'Vodka',   img:'images/vodka/absolut.jpeg'},
  {name:'Smirnoff',       domain:'smirnoff.com',           color:'#a41020', cat:'Vodka',   img:'images/vodka/smirnoff.webp'},
  {name:'Cîroc',          domain:'ciroc.com',              color:'#1a5ca8', cat:'Vodka',   img:'images/vodka/ciroc.webp'},
  {name:'Ketel One',      domain:'ketelone.com',           color:'#1a3a6b', cat:'Vodka',   img:'images/vodka/ketel_one.webp'},
  {name:'Corona',         domain:'corona.com',             color:'#c8900a', cat:'Beer',    img:'images/beer/corona-extra-bottles.jpg'},
  {name:'Heineken',       domain:'heineken.com',           color:'#005e23', cat:'Beer',    img:'images/beer/heineken-original-bottle.png'},
  {name:'Modelo',         domain:'modelo.com',             color:'#003a7a', cat:'Beer',    img:'images/beer/modelo.png'},
  {name:'Stella Artois',  domain:'stellaartois.com',       color:'#002a6a', cat:'Beer',    img:'images/beer/stella_artois.png'},
  {name:'Blue Moon',      domain:'bluemoonbrewing.com',    color:'#1a4a8a', cat:'Beer',    img:'images/beer/blue_moon.png'},
  {name:'Patrón',         domain:'patrontequila.com',      color:'#7b0000', cat:'Tequila', img:'images/Tequila/Patron_Silver.webp'},
  {name:'Don Julio',      domain:'donjulio.com',           color:'#1a4a22', cat:'Tequila', img:'images/Tequila/Don_Julio_Blanco.jpeg'},
  {name:'Casamigos',      domain:'casamigos.com',          color:'#a87a20', cat:'Tequila', img:'images/Tequila/Casamigos_Blanco.avif'},
  {name:'Jose Cuervo',    domain:'cuervo.com',             color:'#8b5800', cat:'Tequila', img:'images/Tequila/Jose_Cuervo_Gold.jpeg'},
  {name:'1800 Tequila',   domain:'1800tequila.com',        color:'#1a1a3a', cat:'Tequila', img:'images/Tequila/1800_Silver.jpeg'},
  {name:'Bacardi',        domain:'bacardi.com',            color:'#111111', cat:'Rum',     img:'images/Rum/Bacardi_Superior_White.jpeg'},
  {name:'Captain Morgan', domain:'captainmorgan.com',      color:'#8b1a00', cat:'Rum',     img:'images/Rum/CaptainMorganSpiced.jpeg'},
  {name:'Malibu',         domain:'malibucocolada.com',     color:'#003060', cat:'Rum',     img:'images/Rum/MalibuCoconutRum.jpeg'},
  {name:"Hendrick's",     domain:'hendricksgin.com',       color:'#1a2a1a', cat:'Gin',     img:'images/Gin/Hendricks_Gin.jpeg'},
  {name:'Bombay Sapphire',domain:'bombaysapphire.com',     color:'#003a8a', cat:'Gin',     img:'images/Gin/Bombay_Sapphire.jpeg'},
  {name:'Tanqueray',      domain:'tanqueray.com',          color:'#004a00', cat:'Gin',     img:'images/Gin/Tanqueray_London_Dry.jpeg'},
  {name:'Barefoot Wine',  domain:'barefootwine.com',       color:'#6a1a30', cat:'Wine',    img:'images/Wine/Brand/Barefoot.jpg'},
  {name:'Kim Crawford',   domain:'kimcrawford.com',        color:'#1a5a2a', cat:'Wine',    img:'images/Wine/Brand/Kim_Crawford.webp'},
  {name:'Josh Cellars',   domain:'joshcellars.com',        color:'#722f37', cat:'Wine',    img:'images/Wine/Brand/Josh_Cellars.webp'},
  {name:'White Claw',     domain:'whiteclaw.com',          color:'#003087', cat:'Seltzer', img:'images/Seltzers/White_Claw_Black_Cherry.jpeg'},
  {name:'High Noon',      domain:'highnoonspirits.com',    color:'#a07020', cat:'Seltzer', img:'images/Seltzers/High_Noon_Watermelon.jpeg'},
  {name:'Truly',          domain:'trulyseltzer.com',       color:'#5a1a8a', cat:'Seltzer', img:'images/Seltzers/Truly_Wild_Berry.jpeg'},
];

/* Cat badge colors */
const CAT_COLORS = {
  Beer:'#f59e0b', Whiskey:'#b45309', Vodka:'#0ea5e9', Tequila:'#65a30d',
  Rum:'#ea580c', Gin:'#16a34a', Wine:'#be123c', Seltzer:'#06b6d4', Cognac:'#92400e',
  Champagne:'#d4af37',
};
