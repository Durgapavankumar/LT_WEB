...
const PRODUCTS = {
  beer: [
    ...
    {name:'Miller Lite',        sub:'American Light Lager',domain:'millerlite.com',      color:'#00539f', sizes:['6-Pack','12-Pack','30-Pack']},
  ...
  whiskey: [
    ...
    {name:'Crown Royal',            sub:'Canadian Whisky',           domain:'crownroyal.com',         color:'#5a1a8a', sizes:['375ml Pint','750ml','1.75L']},
    {name:"Maker's Mark",           sub:'Kentucky Straight Bourbon',  domain:'makersmark.com',        color:'#a41020', sizes:['375ml Pint','750ml','1L','1.75L']},
  ...
  vodka: [
    {name:"Tito's Handmade Vodka",  sub:'Texas Vodka · Corn-based',   domain:'titosvodka.com',        color:'#003087', sizes:['375ml Pint','750ml','1L','1.75L']},
  ...
  tequila: [
    ...
    {name:'Don Julio Blanco',       sub:'Blanco · Highlands Jalisco', domain:'donjulio.com',        color:'#1a4a22', sizes:['375ml Pint','750ml','1.75L']},
